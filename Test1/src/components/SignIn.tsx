...
export const SignIn = withRouter(({ history }) => {
  ...
  const redirectTo =
    queryString(history.location.search).redirect || Routes.Home;
  ...
  return (
    <div className='row'>
      <div className='col-4'>
        ...
        <form
          className={classNames({ error: responseStatus, loading })}
        ...
        <div className='pt-3'>
          ...
          <div className='btn-group'>
            <LinkButton outline-info sm onClick={switchAdmin}>
              admin@email.com
            </LinkButton>
          </div>
        </div>
